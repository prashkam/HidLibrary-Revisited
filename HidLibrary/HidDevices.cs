...
{
    public delegate void HidDeviceInsertedHandler();

    public class HidDevices : IDisposable
    {
        // my code starts here - elekgeek
        ...
        public HidDevices()
        {
            ...
            _timer1.Elapsed += new ElapsedEventHandler(_timerElapsed);
        }
